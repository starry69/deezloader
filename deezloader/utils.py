...
from deezloader.deezer_settings import songs_server, api_album

from mutagen.id3 import ID3, APIC, USLT

from mutagen.flac import FLAC, Picture, FLACNoHeaderError

from deezloader.deezer_settings import api_search_trk, cover, header

from deezloader.others_settings import spotify_client_id, spotify_client_secret
